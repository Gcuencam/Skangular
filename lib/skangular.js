...
var skangular = {
    ...
    main: function() {
        rl.question("Angular app name: ".warn, function(answer) {
            skangular.angularAppName = skangular.upperFirstLetter(answer);
    ...
    generateBasicFile: function(){
        ...
        fs.createReadStream(skangular.templateDirectory + "config")
            .pipe(replaceStream('*****', angularAppName))
            .pipe(fs.createWriteStream(skangular.srcDirectory  + "config" + skangular.angularAppName + ".js"));
...
exports.skangular = skangular.main();